...
Function AppInstalled([String]$AppDir) {
    ...
    EnsureRegistryValue -Path "HKEY_CLASSES_ROOT\Folder\shellex\ContextMenuHandlers\WinMerge" -Name "" -Type String -Value "$wimMergeCLSID"
    EnsureRegistryValue -Path "HKEY_CLASSES_ROOT\Folder\shellex\DragDropHandlers\WinMerge" -Name "" -Type String -Value "$wimMergeCLSID"
...
Function AppUninstalled {
    ...
    EnsureRegistryKeyDeleted -Path "HKEY_CLASSES_ROOT\Folder\shellex\ContextMenuHandlers\WinMerge"
    EnsureRegistryKeyDeleted -Path "HKEY_CLASSES_ROOT\Folder\shellex\DragDropHandlers\WinMerge"
